...
"void Insert{{TABLE_NAME}}(PGconn *conn, {{TABLE_NAME}} u);\n"
"void Update{{TABLE_NAME}}(PGconn *conn, {{TABLE_NAME}} u, const char *where_clause);\n"
"void Delete{{TABLE_NAME}}(PGconn *conn, const char *where_clause);\n"
